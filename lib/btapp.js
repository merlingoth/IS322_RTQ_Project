...
(function() {
    ...
    this.BtappCollection = Backbone.Collection.extend(BtappBase).extend({
        initialize: function(models, options) {
            ...
            this.bind('add', this.customAddEvent, this);
            this.bind('remove', this.customRemoveEvent, this);
            this.bind('change', this.customChangeEvent, this);
        },
    ...
    this.BtappModel = Backbone.Model.extend(BtappBase).extend({
        initialize: function(attributes) {
            ...
            this.bind('change', this.customEvents, this);
        },
        destructor: function() {
    ...
    this.Btapp = BtappModel.extend({
        initialize: function() {
            ...
            this.bind('add:events', this.setEvents, this);
        },
        destructor: function() {
        ...
        connect: function(attributes) {
            ...
            this.bind('client:connected', connected, this);
            return ret;
        },
